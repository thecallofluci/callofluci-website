...
// Site constants
export const SITE_NAME = 'Call Of Luci' as const
export const SITE_URL =
  process.env.SITE_URL || ('https://callofluci.art/' as const)
export const DEFAULT_IMAGE_PATH = '/assets/siteicon.svg' as const
export const FAVICON_IMAGE_PATH = '/assets/favicon.ico' as const
export const TWITTER_HANDLE = '@callofluci' as const
...
export const NEW_PAGE_URL = '/new-page' as const
...
export const NAV_LINKS: NavLink[] = [
  ...
  { name: 'New Page', href: NEW_PAGE_URL },
 ...
 */
export const BLOG_TITLE = 'Call Of Luci:​log' as const
